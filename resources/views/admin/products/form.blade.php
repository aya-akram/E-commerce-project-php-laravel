...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="mb-3">
            ...
            <img width="80" alt="">
            <img width="80" src="{{ asset('uploads/'.$product->image) }}" >
            @error('image')
                <small class="invalid-feedback">{{ $message }}</small>
            @enderror
        </div>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <textarea  name="content_en" rows="5" placeholder="English Content" class="form-control @error('content_en') is-invalid @enderror "> {{ old('content_en',$product->content_en) }}</textarea>
            @error('content_en')
                <small class="invalid-feedback">{{ $message }}</small>
            @enderror
        </div>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <textarea  name="content_ar" rows="5" placeholder="Arabic Content" class="form-control @error('content_ar') is-invalid @enderror "> {{ old('content_ar',$product->content_ar) }}</textarea>
