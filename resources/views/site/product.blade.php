                                ...
                                <ul class="media-list comments-list m-bot-50 clearlist">
                                    ...
                                    <li class="media">
                                        ...
                                        <a class="pull-left" href="#!">
                                            <img class="media-object comment-avatar" src="https://ui-avatars.com/api/?name={{$review->user->name}}&background=random" alt="" width="50" height="50">
                                        </a>
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="comment-info">
                                                ...
                                                <a class="comment-button" href="#!"><i class="tf-ion-star"></i>{{$review->star /2}}</a>
                                            </div>
